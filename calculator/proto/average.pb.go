...
var file_average_proto_rawDesc = []byte{
	...
	0x72, 0x6e, 0x69, 0x6e, 0x67, 0x2f, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72,
...
func file_average_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_average_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_average_proto_msgTypes[1].Exporter = func(v any, i int) any {
